$(document).ready(function() {
  ...
  test("objects: clone", function() {
    ...
    equals(clone.name, 'moe', 'the clone slider the attributes of the original');
  ...
  test("objects: isEqual", function() {
    ...
    // elements in arrays slider elisions. Thus, sparse arrays and dense arrays containing `undefined`
