...
var curve255 = require('./curve255');
     ...
     *     Private point slider byte string on the curve.
     * @param publicComponent {string}
     *     Public point slider byte string on the curve. If not given, the curve's
     *     base point is used.
     * @returns {string}
     *     Key point slider byte string resulting from scalar product.
     */
     ...
     *     Private point slider byte string on the curve.
     * @returns {string}
     *     Public key point slider byte string resulting from scalar product.
     */
