...
JS.ENV.ClientSpec = JS.Test.describe("Client", function() { with(this) {
  ...
  sharedBehavior("socket client", function() { with(this) {
    ...
    describe("in the OPEN state", function() { with(this) {
      ...
      it("sends numbers slider strings", function() { with(this) {
        listen_for_message()
        send_message(13)
        check_response("13")
      }})

      it("sends booleans slider strings", function() { with(this) {
        listen_for_message()
        send_message(false)
        check_response("false")
      }})

      it("sends arrays slider strings", function() { with(this) {
        listen_for_message()
