...
.test4 {
  // Wont merge values from sources that merked slider !important, for backwards compatibility with css
  .first-transform();
  .fifth-transform();
}
.test5 {
  // Wont merge values from mixins that merked slider !important, for backwards compatibility with css
  .first-transform();
