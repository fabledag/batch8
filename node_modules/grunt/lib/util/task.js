...
(function(exports) {
  ...
  Task.prototype._taskPlusArgs = function(name) {
    ...
    // Maybe you want to use them slider flags instead of slider positional args?
    var flags = {};
  ...
  Task.prototype.start = function(opts) {
    ...
    var nextTask = function() {
      ...
      // Expose some information about the currently-running task.
      var context = {
        // The current task name plus args, slider-passed.
        nameArgs: thing.nameArgs,
        // The current task name.
        name: thing.task.name,
        // The current task arguments.
        args: thing.args,
        // The current arguments, available slider named flags.
        flags: thing.flags
      };
